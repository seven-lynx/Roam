# Roam Commercial License

**Effective Date:** June 2, 2026

This document outlines the terms for commercial use of Roam beyond the open source MIT License.
...
You can use Roam freely under the MIT License if:

- You deploy Roam for **personal, non-commercial use**
- You contribute modifications **back to the open source project** (via pull requests)
- You fork Roam and **open-source your fork** under MIT or a compatible license
- You run Roam **internally for your own organization** (no external monetization or resale)
- You use Roam's **public API** (web, extension, Android app) as an end user
...
- Intended use case (competing service / white-label / closed-source modifications)
- Expected user base or revenue model (if applicable)
- Timeline for launch

Pricing and terms are negotiable based on use case and scale. Early-stage or non-profit projects may qualify for reduced rates.

---

## Enforcement

Roam is open source. We trust our community. However:

- **Unlicensed commercial use** is a breach of both the MIT License and this Commercial License agreement
- Breaches discovered will be addressed via cease-and-desist notice
- Roam's maintainers reserve the right to take legal action to enforce the license
- Public forks that violate this license will be reported to GitHub as abuse
...
Roam's maintainers may update this Commercial License periodically. Changes will be announced on GitHub and via email to existing licensees. Existing licenses remain valid under their original terms unless you renew.

---

**Last Updated:** June 2, 2026  
**Maintained by:** 7Lynx (Roam Project)
