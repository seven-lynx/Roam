-- Fix domain exclusion logic in roam() function
-- The previous migration had syntax errors in the domain extraction
  ...
  IF p_collection_id IS NOT NULL THEN
    ...
    WHERE ci.collection_id = p_collection_id
      ...
      AND (
        ...
        p_current_domain IS NULL
        OR (substring(u.url from 'https?://(?:www\.)?([^/?#]+)') != p_current_domain)
      )
