...
CREATE INDEX IF NOT EXISTS idx_moderation_queue_pending_age
...
CREATE INDEX IF NOT EXISTS idx_urls_source_approved
...
CREATE INDEX IF NOT EXISTS idx_urls_subcategory_approved
