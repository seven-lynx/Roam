-- =============================================================================
-- Fix roam v35: array_agg alias was still referencing out-of-scope "u"
-- instead of the subquery alias "t". This was fixed in the v35 migration file
-- but that migration was already marked as applied. This new migration
-- drops the buggy version and recreates it with the correct alias.
-- =============================================================================
