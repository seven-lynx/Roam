-- Final working evaluate_badges with renamed OUT parameters to avoid column ambiguity.
-- OUT: out_badge_id, out_badge_slug, etc.
-- This eliminates the collision between OUT parameter "badge_id" and user_badges.badge_id.
