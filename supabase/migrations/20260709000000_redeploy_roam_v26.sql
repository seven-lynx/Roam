...
--
-- This migration re-runs the intended v26 definition verbatim (TABLESAMPLE variety,
-- weighted-random ordering, interest scoring, subdomain-aware exclusion/suppression,
-- domain cooldowns, the INSERT INTO seen_urls that gives roam its memory, and
-- DEFAULT NULL on every optional parameter) so the remote function matches the code.
-- =============================================================================
