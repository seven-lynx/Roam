-- Add p_subcategory_id filter to roam()
-- When provided, restricts results to URLs in that specific subcategory.
-- Used by the Android app's "Roam within this category" feature.
