-- =============================================================================
-- Wilson Score Floor (Task 8.1)
-- =============================================================================
--
-- Adds AND u.wilson_score > -0.1 to every candidate-pool branch in roam()
-- so chronically-downvoted URLs cannot surface via TABLESAMPLE or the
-- ORDER BY fallback while community rating data is still sparse.
--
-- Also adds a CHECK constraint to urls.wilson_score to prevent invalid values.
--
-- v9 change: single additional predicate in 4 WHERE blocks.
  ...
  IF p_collection_id IS NOT NULL THEN
    ...
    FROM (
      ...
      WHERE  ci.collection_id = p_collection_id
        AND  u.approved       = TRUE
        AND  u.wilson_score   > -0.1          -- v9: floor
