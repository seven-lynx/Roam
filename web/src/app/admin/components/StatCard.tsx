...
export function StatCard({ label, value, description, color = 'text-zinc-900 dark:text-white' }: StatCardProps) {
  return (
    <div className="rounded-lg bg-zinc-50 dark:bg-zinc-900 p-4 text-center card-hover">
      ...
      {description && <div className="text-xs text-zinc-400 dark:text-zinc-500 mt-0.5">{description}</div>}
    </div>
  );
}