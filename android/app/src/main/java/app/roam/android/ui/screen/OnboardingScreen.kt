                                ...
                                scope.launch {
                                    ...
                                    val result = runCatching {
                                        supabase.auth.signUpWith(
                                            Email,
                                            redirectUrl = "app.roam.android://callback",
                                        ) {
                                    ...
                                    result.onSuccess {
                                        // When email confirmations are required, signUpWith returns
                                        // a user but no session. Tell the user to check their inbox.
                                        if (supabase.auth.currentSessionOrNull() == null) {
                                            errorMessage = "Check your inbox to confirm your email, " +
